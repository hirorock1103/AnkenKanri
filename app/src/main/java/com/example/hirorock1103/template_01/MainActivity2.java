...
public class MainActivity2 extends AppCompatActivity {
    ...
    public class MyCommentAdapter extends RecyclerView.Adapter<MyCommentHolder>{
        ...
        public MyCommentHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(MainActivity2.this).inflate(R.layout.item_comment,viewGroup,false);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            View view = LayoutInflater.from(MainActivity2.this).inflate(R.layout.item_row_1,viewGroup, false);
    ...
    private void setView(){
        ...
        firstRow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity2.this, MainAnkenListActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.option1:
                ...
                intent = new Intent(MainActivity2.this, MainAnkenTypeListActivity.class);
                startActivity(intent);

                return true;
            case R.id.option2:

                intent = new Intent(MainActivity2.this, MainAnkenListActivity.class);
                startActivity(intent);
    ...
    private void setViewFor0(){
        ...
        bt_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //open dialog
                Intent intent = new Intent(MainActivity2.this, MainAnkenTypeListActivity.class);
                startActivity(intent);
